...
public class ComputerValidityTest {
    ...
    public void testValidityBadDates() {
        Computer computer = new Computer(null, "mdr", Format.dateFromString("2017-04-05"), Format.dateFromString("2017-04-04"));
    ...
    public void testValidity() {
        Computer computer = new Computer(null, "mdr", Format.dateFromString("2017-04-03"), Format.dateFromString("2017-04-04"));
        Computer computer2 = new Computer(new Company(0, "lol mdr"), "mdr", Format.dateFromString("2017-04-03"), Format.dateFromString("2017-04-04"));
        Computer computer3 = new Computer(new Company(0, "lol mdr"), "mdr", null, Format.dateFromString("2017-04-04"));
        Computer computer4 = new Computer(new Company(0, "lol mdr"), "mdr", Format.dateFromString("2017-04-03"), null);
