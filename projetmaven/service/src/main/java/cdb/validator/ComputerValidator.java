...
public class ComputerValidator {
    ...
    public static void checkValidity(Computer computer) throws InvalidComputerException {
        ...
        } else if (computer.getDiscontinued() != null && !computer.getDiscontinued().after(UtilsValidation.MOST_ANCIENT_DATE)) {
        ...
        } else if (computer.getIntroduced() != null && !computer.getIntroduced().after(UtilsValidation.MOST_ANCIENT_DATE)) {
